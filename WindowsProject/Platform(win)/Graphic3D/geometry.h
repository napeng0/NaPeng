...
//This Header file is the modified copy of header file provided by Michael L. McShaffry and David Graham
//This header file includes some simplified definition of mutiple D3D Classes
...
public:
	...
	inline Vec3(D3DXVECTOR4 v4){ x = v4.x; y = v4.y; z = v4.z; }
};
...
public:
	...
	static const Mat4x4 s_Identity;
...
//Definition of different kinds of vertex
...
//Definitions of triangle iterators for different vertex buffer
